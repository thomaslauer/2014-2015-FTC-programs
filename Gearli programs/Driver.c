...
#pragma config(Motor,  mtr_S1_C1_1,     LEFT_DRIVE_MOTOR, tmotorTetrix, openLoop, reversed)
#pragma config(Motor,  mtr_S1_C1_2,     RIGHT_DRIVE_MOTOR, tmotorTetrix, openLoop)
